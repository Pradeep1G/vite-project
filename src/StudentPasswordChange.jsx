...
export default function StudentPasswordChange(){
    ...
    useEffect(() => {
      ...
      const updatePassword = async () => {
        setisLoading(true);
        const res = await axios.post(serverPath1 + "/studentlogin/dashboard/change_password/" + teamId, { "password": formData.newPassword });
        setisLoading(false);
    ...
    <Alert type={alertType} message={alertMessage}/>
            ...
            <p className="flex flow-row items-center justify-center font-bold text-xl">Change Password</p>
                <div className="">
                <input
