    ...
    <>
      ...
      <div className="login_bg s:p-20 py-4">
        ...
        <div className="hidden">
          ...
          <p className="font-semibold text-center text-2xl p-0">Instructions For Students⚡⚡</p>

          <br></br>

         <p> 1. Chapter 1  - Introduction - Page number starts with 1 from this page onwards.</p>
         <p> 2. Inform everyone to follow the same chapter headings as in Template given. (subdivisions can vary).</p>
         <p> 3. Under Chapter 3, inside 3.1, they can include OBJECTIVE of the Project and its necessity.</p>
         <p> 4. From the first page till List of Tables, the page numbers will be in Roman letters. From Chapter 1 onwards, digits based numbering style.</p>
         <p> 5. Instruct the students to strictly adhere to the template.</p>
          ...
          <div className=" lg:flex lg:flex-row justify-center space-x-3 flex-col space-y-2">
            ...
            <a href="https://drive.google.com/file/d/1LQzZmfyRaHpW9nJTVAXIVSpXXsa-Ztk3/view?usp=sharing" ><button className="bg-red-900 text-white px-6 py-2 mt-4 rounded-md my-2 text-lg">Project-Report Template</button></a>
            <a href="https://docs.google.com/presentation/d/1cobAi_62TYNG96NgALy9NnjIifKzlaG2/edit?usp=sharing&ouid=113013420184703351472&rtpof=true&sd=true"><button className="bg-red-900 text-white px-6 py-2 rounded-md my-2 text-lg">PPT Template</button></a>
            <a href="https://docs.google.com/spreadsheets/d/14aITm8U3IT1iApeSQRlPKDQIhE3xg2NM/edit?usp=sharing&ouid=113013420184703351472&rtpof=true&sd=true"><button className="bg-red-900 text-white px-6 py-2 rounded-md my-2 text-lg">Staff Mail Id's</button></a>
            <a href="https://drive.google.com/file/d/1OiR_xbgeQHJhvG4ecPywEmccnnWHwzcI/view?usp=sharing" ><button className="bg-red-900 text-white px-6 py-2 rounded-md my-2 text-lg">Exam Shedule</button></a>
