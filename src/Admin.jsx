          ...
          <div className={ 'block'}>
            ...
            <div className='justify-center'>
                ...
                <div className=' flex flex-col justify-center'>
                  <a href='/admin/deleteteam' className='bg-red-900 text-white px-6 py-2 rounded-md my-2 text-lg text-center' >
                    Delete Team
                  </a>
                ...
                <div className=' flex flex-col justify-center'>
                <a href='/admin/addteam' className='bg-red-900 text-white px-6 py-2 rounded-md my-2 text-lg text-center' >
                    Add Team
                  </a>
